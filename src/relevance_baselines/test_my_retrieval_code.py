...
class claim_as_represented_by_document():
    #object of a claim holding its representation with each document - > docLM
...
def represent_claim_with_claim_LM_prob_vector(claim_entity_list):
    ...
    term_stem_tf_idf_wiki = utils.read_pickle("term_stem_tf_idf_wiki_body")
...
#     wiki_docs_path = r"C:\supporting_evidence\wikipedia_movie_articles_0614"
    wiki_docs_path = r"C:\study\supporting_evidence\wiki_with_body\wikipedia_movie_articles_0614_with_body"
    ...
    for (curr_entity,curr_clm) in claim_entity_list:
        ...
        #class trial
#         claim_inst = claim_as_represented_by_document()
...
#     utils.save_piczkle("claim_represented_by_docLM_vector_for_beta", claim_representations_by_docLM_objects) 
...
def create_term_stem_tf_idf_dict():
    term_stem_file_path_wiki = r"C:\study\technion\MSc\Thesis\Y!\support_test\retrieval_baseline\wiki_terms_stem_body"
    term_tf_file_path_wiki = r"C:\study\technion\MSc\Thesis\Y!\support_test\retrieval_baseline\wiki_tf_body"
    term_idf_file_path_wiki = r"C:\study\technion\MSc\Thesis\Y!\support_test\retrieval_baseline\wiki_idf_body"
    ...
    utils.save_pickle("term_stem_tf_idf_wiki_body", term_stem_tf_idf_wiki)
    with open("term_stem_tf_idf_wiki_body.csv", 'wb') as csvfile:
...
#                     specific_alpha_all_betas_CE_res.append(math.exp(CE_res))
                    specific_alpha_all_betas_CE_res.append(CE_res)
...
#     claims_entity_doc_path = r"C:\study\technion\MSc\Thesis\Y!\claims_support_test.txt"
    claims_entity_doc_path = r"C:\study\technion\MSc\Thesis\Y!\toy_story_claim.txt"
    wiki_docs_path = r"C:\supporting_evidence\wikipedia_movie_articles_0614_body"
